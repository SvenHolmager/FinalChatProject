...
public class WebServer extends Thread {
    ...
    public void run() {
        ...
        try (
            ...
            filePath = "C:\\Users\\DBAdmin\\Desktop\\ChatServer" + URI;
            ...
            if (file.isFile()) {
                ...
                filePath = "C:\\Users\\DBAdmin\\Desktop\\ChatServer\\error.html";
                file = new File(filePath);
                statusCode = 301;
            ...
            if (URI.equals("/log.html") || URI.equals("/users.html")) {//he did
                ...
                if (URI.equals("/log.html")) {
                    file = new File("C:\\Users\\DBAdmin\\Desktop\\ChatServer\\chatServerLog.txt");
                    ...
                    file = new File("C:\\Users\\DBAdmin\\Desktop\\ChatServer\\onlineUsers.txt");
    ...
    public void sendResponse(DataOutputStream out, String status, int statusCode, boolean isFile, File file, String URI, String fileHTML) throws IOException {
        ...
        if (statusCode == 301) {
            out.writeBytes("Location: http://chatserver.cloudapp.net:8080/error.html" + NL);
        }
        if (URI.equals("/webServerLog.txt") || URI.equals("/documentation.pdf")|| URI.equals("/ChatServer.jar")|| URI.equals("/chatServerLog.txt")) {
            out.writeBytes("Content-Disposition: attachment; filename=\"C:\\Users\\DBAdmin\\Desktop\\ChatServer\\" + URI + NL);                                                         
        }
